...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MainView (Context context) {
        ...
        Assets.sound_thump = Assets.soundPool.load(context, R.raw.bonk, 1);
        Assets.sound_eating = Assets.soundPool.load(context, R.raw.eating, 1);
        Assets.sound_game_over = Assets.soundPool.load(context, R.raw.game_over, 1);
        Assets.sound_victory = Assets.soundPool.load(context, R.raw.victory, 1);
        Assets.sound_eating = Assets.soundPool.load(context, R.raw.eating, 1);
